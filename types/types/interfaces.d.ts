...
export declare function isCustomerData(data: {
    securityCode: string;
} | ICustomerData): data is ICustomerData;
export declare function isSecurityCode(data: {
    securityCode: string;
} | ICustomerData): data is {
    securityCode: string;
};
...
export interface SdkEvents {
    ...
    ready: void;
    disconnected: (info: string, eventData: {
